<template>
  <svg class="token" width="54" height="39" viewBox="0 0 54 39" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
      <g fill-rule="nonzero" stroke="#2c2f31" stroke-width=".5">
          ...
          <path serif:id="Shape" d="M44.438 22.669c-11.056 5.324-27.64 5.566-37.253.484-9.614-5.081-8.413-13.308 2.643-18.631 11.056-5.324 27.64-5.566 37.254-.484 9.614 5.081 8.412 13.308-2.644 18.631z" :fill="tokenColor"/>
      </g>
